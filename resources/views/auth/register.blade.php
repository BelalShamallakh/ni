...
<head>
    ...
    <style>
        * {
        ...
        .welcome-container {
            /* background: #eeeeee75; */
            background: url(https://images.unsplash.com/photo-1443884590026-2e4d21aee71c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2043&q=80);
...
<body>
    <div class="container">
        <main class="signup-container">
            <h1 class="heading-primary">Regiester<span class="span-blue">.</span></h1>
            ...
            <form class="signup-form" method="POST" action="{{ route('register') }}">
                ...
                <input id="password" type="password-confirm" class="input-text"
        ...
        <div class="welcome-container">
            ...
            {{-- <img src="https://images.unsplash.com/photo-1443884590026-2e4d21aee71c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2043&q=80" alt=""> --}}
        </div>
    </div>
    <script>
